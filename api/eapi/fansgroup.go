...
// Endpoints:
//   - /api/fans/group/mission/all (获取乐迷团任务列表, EAPI)
//   - /api/social/fansgroup/bff/detail/get (获取乐迷团详情含boardId, EAPI)
//   - /api/fans/group/feed/recommend/get (获取乐迷团推荐Feed, EAPI)
//   - /api/fans/group/mission/forward/progress (分享进度上报, EAPI)
//   - /api/resource/like (点赞资源, EAPI)
...
// 接口: /api/social/fansgroup/bff/detail/get?groupId={id}
// 加密: EAPI
...
// 接口: /api/fans/group/mission/all?fansGroupId={id}
// 加密: EAPI
...
// ===================== 获取乐迷团推荐 Feed (FansGroupFeedRecommend) =====================
...
// 接口: /api/fans/group/feed/recommend/get
// 加密: EAPI
...
// ===================== 分享进度上报 (FansGroupMissionForwardProgress) =====================
...
// 接口: /api/fans/group/mission/forward/progress
// 加密: EAPI
...
// ===================== 获取用户在乐迷团的详情 (FansGroupUserGroupDetailGet) =====================
...
// 接口: /api/social/fansgroup/bff/user/group/detail/get?groupId={id}
// 加密: EAPI
